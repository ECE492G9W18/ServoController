...
add_instance red_leds altera_avalon_pio 17.0
set_instance_parameter_value red_leds {bitClearingEdgeCapReg} {0}
set_instance_parameter_value red_leds {bitModifyingOutReg} {0}
set_instance_parameter_value red_leds {captureEdge} {0}
set_instance_parameter_value red_leds {direction} {Output}
set_instance_parameter_value red_leds {edgeType} {RISING}
set_instance_parameter_value red_leds {generateIRQ} {0}
set_instance_parameter_value red_leds {irqType} {LEVEL}
set_instance_parameter_value red_leds {resetValue} {0.0}
set_instance_parameter_value red_leds {simDoTestBenchWiring} {0}
set_instance_parameter_value red_leds {simDrivenValue} {0.0}
set_instance_parameter_value red_leds {width} {10}

add_instance sysid_qsys_0 altera_avalon_sysid_qsys 17.0
...
add_interface red_leds_external_connection conduit end
set_interface_property red_leds_external_connection EXPORT_OF red_leds.external_connection
...
add_connection clk_0.clk red_leds.clk

add_connection clk_0.clk sysid_qsys_0.clk

add_connection clk_0.clk_reset red_leds.reset

add_connection clk_0.clk_reset sysid_qsys_0.reset

add_connection hps_0.h2f_lw_axi_master red_leds.s1
set_connection_parameter_value hps_0.h2f_lw_axi_master/red_leds.s1 arbitrationPriority {1}
set_connection_parameter_value hps_0.h2f_lw_axi_master/red_leds.s1 baseAddress {0x0000}
set_connection_parameter_value hps_0.h2f_lw_axi_master/red_leds.s1 defaultConnection {0}
...
set_connection_parameter_value hps_0.h2f_lw_axi_master/sysid_qsys_0.control_slave baseAddress {0x0100}
set_connection_parameter_value hps_0.h2f_lw_axi_master/sysid_qsys_0.control_slave defaultConnection {0}

add_connection hps_0.h2f_reset red_leds.reset
